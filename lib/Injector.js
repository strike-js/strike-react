...
var Injector = (function () {
    ...
    Injector.prototype.injectFunction = function (fn, ctx) {
        ...
        fn.$inject = fn.$inject || strikejs_util_1.extractArgumentsFromFunction(fn);
    ...
    Injector.prototype.register = function () {
        ...
        callback.$inject = callback.$inject ||
            (typeof callback.factory === "function" && strikejs_util_1.extractArgumentsFromFunction(callback.factory)) ||
            (strikejs_util_1.extractArgumentsFromFunction(callback));
