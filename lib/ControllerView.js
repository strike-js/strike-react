...
function createControllerView(_a) {
    var component = _a.component, reducer = _a.reducer, initialState = _a.initialState, deps = _a.deps, propsModifier = _a.propsModifier, propsToPropagate = _a.propsToPropagate, initializer = _a.initializer, stateKey = _a.stateKey;
    var store = null;
    var injector = null;
    var propsObject = {
        data: null,
